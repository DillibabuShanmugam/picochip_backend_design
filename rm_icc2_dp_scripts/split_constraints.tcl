...
#pk if {$DP_INTERMEDIATE_LEVEL_BLOCK_REFS != ""} {
#pk    if {$INTERMEDIATE_BLOCK_VIEW == "abstract"} {
#pk      puts "RM-info : splitting constraints with -hier_abstract_subblocks"
#pk      split_constraints -force -hier_abstract_subblocks $DP_INTERMEDIATE_LEVEL_BLOCK_REFS -nosplit
#pk    } else {
#pk      puts "RM-info : splitting constraints using -design_subblocks"
#pk      split_constraints -design_subblocks $DP_INTERMEDIATE_LEVEL_BLOCK_REFS -nosplit
#pk    }
#pk } else {
#pk    puts "RM-info : splitting constraints"
#pk    split_constraints -nosplit
#pk }
