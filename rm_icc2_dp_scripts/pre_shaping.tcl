...
#pk      if {$DISTRIBUTED} {
#pk         puts "RM-info : Creating Placement Abstracts (distributed) for all blocks"
#pk         create_abstract -force_recreate -placement -host_options block_script -all_blocks
#pk      } else {
#pk         puts "RM-info : Creating Placement Abstracts (non-distributed) for all blocks"
#pk         create_abstract -force_recreate -placement -all_blocks
#pk      }
   } else {
        if {$DISTRIBUTED} {
