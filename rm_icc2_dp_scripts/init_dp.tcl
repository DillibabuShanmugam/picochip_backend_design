...
if {$CHECK_DESIGN} { 
   redirect -file ${REPORTS_DIR_INIT_DP}/check_design.pre_floorplan \
    ...
    #{check_design -ems_database check_design.pre_floorplan.ems -checks dp_pre_floorplan -open_message_browser} #pk: open_message_browser to open the ems browser in gui
}
