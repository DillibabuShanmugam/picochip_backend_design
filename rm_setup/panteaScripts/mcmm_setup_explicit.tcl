...
set mode1 				"normalMode" ;# name for mode1	
set mode_constraints($mode1)            "./frontend_output/picochip_dare.sdc" ;# for mode1 specific SDC constraints

## Corner constraints; expand it as needed
set corner1 				"normalCorner" ;# name of corner1	
set corner_constraints($corner1)        "./frontend_output/picochip_dare.sdc" ;# for corner1 specific SDC constraints 
...
set scenario_constraints($scenario1)    "./frontend_output/picochip_dare.sdc" ;# for scenario1 specific SDC constraints
