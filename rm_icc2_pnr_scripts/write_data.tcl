...
#pk : use this gds for lvs and drc
write_gds -hierarchy all -long_names -keep_data_type -merge_files ${gds_files} ${OUTPUTS_DIR}/picochip_test_merged.gds
set_app_options -name "file.gds.text_all_pins" -value true
write_gds -hierarchy all -long_names -keep_data_type -output_pin text -output_net_text -net_text_on all_shapes_and_vias -layer_map ${WRITE_GDS_LAYER_MAP_FILE} -merge_files ${gds_files} ${OUTPUTS_DIR}/picochip_lvs_merged.gds
#pk : verilog for lvs 
write_verilog -exclude {scalar_wire_declarations leaf_module_declarations empty_modules well_tap_cells filler_cells} -force_no_reference {TAPCELLBWP7T PCORNER PFILLER0005 PFILLER05 PFILLER1 PFILLER5 PFILLER10 PFILLER20 FILL1BWP7T FILL2BWP7T FILL4BWP7T FILL8BWP7T FILL16BWP7T FILL32BWP7T FILL64BWP7T PAD70N} -hierarchy all ${OUTPUTS_DIR}/${WRITE_DATA_BLOCK_NAME}_lvs.v
#pk : verilog for pt
write_verilog -compress gzip -exclude {scalar_wire_declarations leaf_module_declarations pg_objects end_cap_cells well_tap_cells filler_cells pad_spacer_cells physical_only_cells cover_cells flip_chip_pad_cells} -force_no_reference {TAPCELLBWP7T PCORNER PFILLER0005 PFILLER05 PFILLER1 PFILLER5 PFILLER10 PFILLER20 FILL1BWP7T FILL2BWP7T FILL4BWP7T FILL8BWP7T FILL16BWP7T FILL32BWP7T FILL64BWP7T PAD70N} -hierarchy all ${OUTPUTS_DIR}/${WRITE_DATA_BLOCK_NAME}.pt.v

##pk: drawing boundary:
##create shape in gui:
start_gui
##left:
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -start CreateShapeTool
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {-113 -113}
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {-113 4881.24}
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -reset
##top:
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -start CreateShapeTool
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {-113 4881.24}
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {2884.52 4881.24}
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -reset
##right:
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -start CreateShapeTool
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {2884.52 4881.24}
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {2884.52 -113}
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -reset
##bottom:
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -start CreateShapeTool
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -add_point {-113 -113}
...
gui_mouse_tool -window [gui_get_current_window -types Layout -mru] -reset
#write gds again:
write_gds -compress -hierarchy all -long_names -keep_data_type ${OUTPUTS_DIR}/picochip_with_boundary.gds
save_block

write_gds -compress -hierarchy all -long_names -keep_data_type -merge_files ${gds_files} ${OUTPUTS_DIR}/picochip_with_boundary_merged.gds

write_gds -hierarchy all -long_names -keep_data_type -merge_files ${gds_files} ${OUTPUTS_DIR}/picochip_intermediate_merged.gds
