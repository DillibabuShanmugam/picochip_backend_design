...
if {[file exists [which $TCL_USER_ROUTE_AUTO_SCRIPT]]} {
	...
	} elseif {$CLOCK_OPT_GLOBAL_ROUTE_OPT} {

		##########################################################################
		## Routing with global route optimization (optional)
		##########################################################################
		## To use atomic routing commands without global route optimization: Refer to templates/route_auto.atomic.tcl for sample commands
